const links = [
    ...
    {text1:'Number 2',text2:'Nothing Ear (a)',href:'https://m.media-amazon.com/images/I/71KjGMCidYL.jpg',src:'https://m.media-amazon.com/images/I/71KjGMCidYL.jpg'},
...
document.getElementById('dImage3').src=links[linkIndex].src;
});
